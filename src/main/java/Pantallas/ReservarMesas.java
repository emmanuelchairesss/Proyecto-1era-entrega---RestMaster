...
public class ReservarMesas extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ReservarMesas
     */
    ...
    private void inicializarMesas() {
        ...
        for (JButton btnMesa : btnMesas) {
            btnMesa.setBackground(new Color(102,153,0));
            ...
            btnMesa.addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    if (e.getClickCount() == 2) {
                        cambiarEstadoMesa("ocupada", Color.RED); 
                    }
                }
            });
        }
    ...
    private void resaltarBotonReservar() {
        btnReservarMesa.setEnabled(true);
        btnReservarMesa.setFont(new Font("Arial", Font.BOLD, 18));
        btnReservarMesa.setBackground(new Color(255, 200, 0)); 
    }

    public void restaurarBotonReservar() {
        btnReservarMesa.setEnabled(false);
        btnReservarMesa.setFont(new Font("Arial", Font.PLAIN, 12));
        btnReservarMesa.setBackground(null);
    }
    ...
    public void cambiarEstadoMesa(String estado, Color color) {
        ...
        try {
            ...
            String sql = "UPDATE dbo.TblReservarMesas SET Estado = ? WHERE Mesa = ?";
            PreparedStatement ps = conexion.establecerConexion().prepareStatement(sql);
            ps.setString(1, estado);
            ps.setString(2, mesaSeleccionada.getText());
            ps.executeUpdate();
            conexion.cerrarConexion();

            
            if ("ocupada".equals(estado)) {
             //   registrarEnHistorial(mesaSeleccionada.getText());
            }
        ...
        for (JButton mesa : btnMesas) {
            ...
            switch (estado) {
                ...
                case "ocupada":
                    ...
                    break;
                case "reservada":
                    mesa.setBackground(Color.YELLOW);
                    break;
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel18Layout.setVerticalGroup(
            jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(btnMesa6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
        );
    ...
    if (mesaSeleccionada != null && estadosMesas.get(mesaSeleccionada).equals("disponible")) {
        ...
        if (formularioDialog.isReservaExitosa()) {
            ...
            mesaSeleccionada.setBackground(Color.YELLOW);
    ...
    if (mesaSeleccionada != null && estadosMesas.get(mesaSeleccionada).equals("reservada")) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                ...
                mesaSeleccionada.setBackground(Color.GREEN);
